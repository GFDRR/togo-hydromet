...
from base.models import Limite  # importing all models from Donnees_de_Base where data about Contacts are stored
from hydromet.models import ObservateurHydromet, Observation, Log, Station
...
class SmsGateway(AppBase):
    def handle(self, msg):
        ...
        observer = ObservateurHydromet.objects.filter(actif=True, personne__telephone_bureau=tel, personne__actif=True).first()
