# Django settings for togohydromet project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a togohydromet directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'togohydromet')
...
ROOT_URLCONF = 'togohydromet.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'togohydromet.wsgi.application'
